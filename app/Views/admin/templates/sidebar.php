      ...
      <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link <?php if($page == "pesan") echo "active";  ?>" href="<?= base_url('admin/pesan')  ?>">
              <div class="fas fa-envelope icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"></div>
